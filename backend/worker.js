...
규칙:
- 옆 차도의 차량은 무시한다. (내 앞을 가로지르거나 인도로 올라오는 차만 "정지, 앞 차량 접근")
- 계단(특히 내려가는)·턱·전봇대·볼라드·입간판·기둥·문·공사·기타 장애물은 "앞 장애물"(또는 계단이면 "앞 계단 주의", 턱이면 "앞 턱 주의").
- 앞을 막는 사람은 "앞 사람". 인도가 끊기면 "보도 끝 주의". 차도로 나가는 상황이면 "차도입니다, 인도로".
